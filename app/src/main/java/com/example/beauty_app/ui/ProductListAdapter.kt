...
class ProductListAdapter(private val products: List<MakeupItem>, private val viewModel: SearchViewModel) : RecyclerView.Adapter<ProductViewHolder>() {
        ...
        holder.itemView.setOnClickListener{
            if(clickDebounce()){
                ...
                holder.itemView.findNavController().navigate(
                    R.id.action_searchFragment_to_productInfoFragment, bundleOf(
